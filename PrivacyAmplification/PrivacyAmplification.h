...
const uint8_t cufftExecR2C_key_hash[] = { 0x7E, 0xF7, 0xCD, 0x69, 0xD4, 0x28, 0xE5, 0xC6,
                                          0xA2, 0xB5, 0x5C, 0xD2, 0xC6, 0xB6, 0x79, 0x54,
                                          0x75, 0x68, 0x59, 0xB4, 0x1C, 0xF1, 0x54, 0xB7,
                                          0xB9, 0x04, 0xEF, 0xA2, 0x82, 0x4A, 0x65, 0x84 };

const uint8_t cufftExecR2C_seed_hash[] = { 0x2F, 0xE4, 0xDC, 0xEE, 0x22, 0x5B, 0x7F, 0x00,
                                           0x81, 0x9A, 0x0A, 0x0B, 0x73, 0x9E, 0x73, 0x9A,
                                           0x42, 0x22, 0x1D, 0x05, 0x27, 0x83, 0x6B, 0xB3,
                                           0x78, 0xE8, 0xA0, 0xF7, 0x96, 0x90, 0xE7, 0xDA };

const uint8_t cufftExecR2C_key_hash_first_zero[] = { 0xE0, 0x52, 0xAF, 0x53, 0x2B, 0x58, 0xDD, 0xC0,
                                                     0x55, 0xCF, 0x2B, 0xA2, 0xDB, 0x47, 0x6B, 0xD6,
                                                     0x08, 0xDC, 0x16, 0xB0, 0xCE, 0x00, 0x29, 0xB1,
                                                     0x13, 0x23, 0x46, 0xFE, 0x9C, 0xB7, 0xEF, 0x14 };

const uint8_t cufftExecR2C_seed_hash_first_zero[] = { 0x9E, 0xB2, 0x3C, 0x35, 0xAD, 0x28, 0x9A, 0xBB,
                                                      0x08, 0xED, 0xD6, 0xFB, 0x75, 0xDD, 0xAF, 0xE9,
                                                      0x97, 0x11, 0x15, 0x92, 0xC4, 0x3F, 0x8D, 0xC9,
                                                      0x06, 0xB9, 0xA0, 0x44, 0x52, 0x0B, 0x96, 0xE0 };

const uint8_t cufftExecC2R_input_hash[] = { 0x9E, 0x5A, 0x4B, 0x93, 0x01, 0x5A, 0x8B, 0xDA,
                                            0x64, 0x4E, 0x02, 0x06, 0x99, 0x3D, 0xB8, 0x0F,
                                            0xD8, 0x4A, 0x3F, 0x13, 0x1D, 0xFB, 0xFD, 0xE8,
                                            0x4A, 0x76, 0x3F, 0x2E, 0xCE, 0x97, 0x8B, 0x3E };
