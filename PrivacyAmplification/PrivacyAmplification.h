...
const uint8_t binInt2float_key_binIn_hash[] = { 0xDD, 0xA6, 0xC6, 0x78, 0xC1, 0x12, 0xAC, 0x3D,
                                                ...
                                                0x88, 0x7B, 0x48, 0x08, 0x11, 0xB2, 0xD4, 0x48,
                                                0xB6, 0x1E, 0xA4, 0x19, 0xBE, 0x77, 0xC0, 0xBD };

const uint8_t binInt2float_key_floatOut_hash[] = { 0x85, 0xC7, 0x9A, 0x40, 0xBA, 0x55, 0xB1, 0xF7,
                                                   0x14, 0x74, 0xD8, 0x41, 0xEF, 0xBC, 0x38, 0xE8,
                                                   0x0B, 0x77, 0x9E, 0xC7, 0x10, 0xA9, 0x99, 0x62,
                                                   0x41, 0x9D, 0x90, 0x91, 0x0A, 0xE6, 0x43, 0x25 };

const uint8_t binInt2float_seed_binIn_hash[] = { 0x45, 0xEC, 0x22, 0xFE, 0x52, 0x30, 0xDE, 0x82,
                                                 0x5B, 0xB6, 0x6F, 0x8D, 0x2E, 0x73, 0xA2, 0xDA,
                                                 0x75, 0xB3, 0x33, 0x41, 0x25, 0xA7, 0x47, 0xFC,
                                                 0xDC, 0xD4, 0xC0, 0x91, 0x56, 0x24, 0x90, 0x40 };

const uint8_t binInt2float_seed_floatOut_hash[] = { 0xD9, 0x18, 0x97, 0xB8, 0x7E, 0x7C, 0xDC, 0xFD,
                                                    0xD6, 0xCA, 0x6B, 0x91, 0x7E, 0x80, 0xCB, 0xFF,
                                                    0xE9, 0x86, 0xB1, 0x76, 0x9A, 0x4D, 0xBC, 0x49,
                                                    0x74, 0x42, 0x99, 0xB8, 0x13, 0xD2, 0x2B, 0x11 };
...
const uint8_t key_rest_hash[] = { 0xA5, 0x2D, 0x8B, 0x84, 0x90, 0x85, 0xC8, 0x1D,
                                  0x09, 0xAE, 0xCF, 0x6D, 0x5D, 0x98, 0x82, 0x90,
                                  0x0A, 0x2A, 0x97, 0x25, 0x3E, 0x9F, 0x0B, 0xB8,
                                  0xCF, 0x7B, 0x76, 0xE2, 0xD3, 0xC7, 0x79, 0x7D };
